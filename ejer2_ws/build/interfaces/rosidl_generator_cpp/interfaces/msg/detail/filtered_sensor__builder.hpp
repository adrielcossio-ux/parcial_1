...
class Init_FilteredSensor_stamp
{
public:
  explicit Init_FilteredSensor_stamp(::interfaces::msg::FilteredSensor & msg)
  : msg_(msg)
  {}
  ::interfaces::msg::FilteredSensor stamp(::interfaces::msg::FilteredSensor::_stamp_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_FilteredSensor_stamp sensor3(::interfaces::msg::FilteredSensor::_sensor3_type arg)
  {
    msg_.sensor3 = std::move(arg);
    return Init_FilteredSensor_stamp(msg_);
  }
