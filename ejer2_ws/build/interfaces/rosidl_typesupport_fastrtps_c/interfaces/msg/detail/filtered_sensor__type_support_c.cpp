...
#include "interfaces/msg/detail/filtered_sensor__rosidl_typesupport_fastrtps_c.h"
...
using _FilteredSensor__ros_msg_type = interfaces__msg__FilteredSensor;
...
size_t get_serialized_size_interfaces__msg__FilteredSensor(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FilteredSensor__ros_msg_type * ros_message = static_cast<const _FilteredSensor__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _FilteredSensor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__FilteredSensor(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__FilteredSensor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__FilteredSensor;
    is_plain =
      (
...
static size_t _FilteredSensor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__FilteredSensor(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, FilteredSensor)() {
