...
class AverageNode(Node):
    def __init__(self):
        ...
        self.sub1 = self.create_subscription(Float64, '/sensor1', self.cb1, 10)
        self.sub2 = self.create_subscription(Float64, '/sensor2', self.cb2, 10)
        self.sub3 = self.create_subscription(Float64, '/sensor3', self.cb3, 10)
